...
video_path = "15.mp4"  # Replace with the path to your video file
...
while cap.isOpened():
    ...
    # Display fall detection status on the video
    if fall_detected:
        cv2.putText(frame, "Fall Detected!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    else:
        cv2.putText(frame, "No Fall", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

    # Show the frame
    cv2.imshow('Fall Detection', frame)

    # Exit on 'q' key press or wait for the next frame
